...
class SecurityGroupServerRpcCallback(n_rpc.RpcCallback):
    ...
    def _get_devices_info(self, devices):
        ...
        for device in devices:
            ...
            if port['device_owner'] == constants.DEVICE_OWNER_ROUTER_INTF or \
               port['device_owner'] == constants.DEVICE_OWNER_ROUTER_HA_INTF or \
               port['device_owner'] == constants.DEVICE_OWNER_FLOATINGIP:
