...
class OVSNeutronAgent(n_rpc.RpcCallback,
    ...
    def __init__(self, integ_br, tun_br,ex_br, local_ip,
        ...
        self.ex_br = ovs_lib.OVSBridge(ex_br, self.root_helper)
    ...
    def get_external_device_name(self, port_id):
        return (constants.EXTERNAL_DEV_PREFIX + port_id)[:constants.DEV_NAME_LEN]


    def scan_ports(self, registered_ports, updated_ports=None):
        cur_ex_ports = self.ex_br.get_vif_port_set()
        cur_int_ports = self.int_br.get_vif_port_set()
        cur_ports = cur_ex_ports | cur_int_ports
...
def create_agent_config_map(config):
    ...
    kwargs = dict(
        ...
        ex_br=config.OVS.external_network_bridge,
